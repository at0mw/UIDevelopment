...
const objectsModule = (() => {
    ...
    //    serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/pages/objects/objects-emulator.json");
      ...
      function createPresets(shadePresets) {
          ...
          presetManager = new DynamicListMenuLogic('demo', dynamicMenuId, dynamicListButtonId, shadePresetContainer, editableButtonId, 
              itemsPerPage, backButtonId, forwardButtonId);
      ...
      function generateShadePresetHTML(presets) {
          return presets.map(preset => ({
              ...
              order: preset.order,
              html: 
              `<div class="list-button button demo-list-dynamic" id="demo-listButton${preset.id}" draggable="false">    
      ...
      function nextPage() {        
        ...
        const shadePresetConfigSubscription = CrComLib.subscribeState('s', "22", (value) => {       
        ...
        function parsePresetConfigJsonString(presetConfigJson){
            console.log("Feedback CrComLib :::: Shade Control ::: Receiving Preset Config Feedback :: Value: ", presetConfigJson);
     ...
     */
    let loadedSubId = CrComLib.subscribeState('o', 'ch5-import-htmlsnippet:objects-import-page', (value) => {
        if (value['loaded']) {
            onInit();
            setTimeout(() => {
                CrComLib.unsubscribeState('o', 'ch5-import-htmlsnippet:objects-import-page', loadedSubId);
                loadedSubId = '';
            });
        }
    }); 
